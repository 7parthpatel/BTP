...
function datagenerate()
{
	...
	totalvehicle = []
		...
		TMP = [10,a,b,WMV2,CarV,BusV,LGV,HGVR2,HGVR3,HGVR4,HGVA3,HGVA5,HGV,AMV];
		...
		ten = setInterval(function(){	rn = Math.floor(Math.random() * ( latitude[9].length - 0 )) + 0; lat = latitude[9][rn];	lng = longitude[9][rn];/*allv = [10,lat,lng];client.publish('sensor1',allv.toString());*/console.log(10,lat,lng);},(60000/totalvehicle[0][13]));

		setTimeout(function(){clearInterval(ten);client.publish('sensor1',TMP.toString());
