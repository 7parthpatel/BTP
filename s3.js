...
function datagenerate()
{
	...
	totalvehicle = []
		...
		TMP = [3,a,b,WMV2,CarV,BusV,LGV,HGVR2,HGVR3,HGVR4,HGVA3,HGVA5,HGV,AMV];
		...
		third = setInterval(function(){	rn = Math.floor(Math.random() * ( latitude[2].length - 0 )) + 0; lat = latitude[2][rn];	lng = longitude[2][rn];/*	allv = [3,lat,lng];client.publish('sensor1',allv.toString());*/console.log(3,lat,lng);},(60000/totalvehicle[0][13]));
	
		setTimeout(function(){clearInterval(third);
