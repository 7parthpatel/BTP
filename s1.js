...
function datagenerate()
{
	...
	totalvehicle = []
		...
		TMP = [1,a,b,WMV2,CarV,BusV,LGV,HGVR2,HGVR3,HGVR4,HGVA3,HGVA5,HGV,AMV];
		...
		first = setInterval(function(){	rn = Math.floor(Math.random() * ( latitude[0].length - 0 )) + 0; lat = latitude[0][rn];	lng = longitude[0][rn];/*allv = [1,lat,lng];client.publish('sensor1',allv.toString());*/console.log(1,lat,lng);},(60000/totalvehicle[0][13]));
		
		setTimeout(function(){clearInterval(first);
